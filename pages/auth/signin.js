...
// Import Client and Account from appwrite SDK

const endpoint = 'https://cloud.appwrite.io/v1'; // Your Appwrite API endpoint
const projectId = '666cb2b6002f3da2d7c3'; // Your Appwrite project ID
...
export default function Signin() {
  ...
  const router = useRouter(); // Assuming you're using Next.js useRouter hook
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      router.push('/'); // Redirect to home page or another route upon successful sign-in
    } catch (error) {
